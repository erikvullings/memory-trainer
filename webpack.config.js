  ...
  return {
    ...
    plugins: [
      ...
      new HtmlWebpackTagsPlugin({
        metas: [
          {
            attributes: { property: 'og:title', content: 'Memory Trainer' },
          },
          {
            attributes: {
          ...
          },
          {
            attributes: {
              property: 'og:url',
              content: 'https://erikvullings.github.io/memory-trainer',
            },
          },
          {
          ...
          {
            attributes: { property: 'og:site_name', content: 'PB' },
          },
          {
            attributes: { property: 'og:image:alt', content: 'Memory Trainer' },
          },
          {
            attributes: {
